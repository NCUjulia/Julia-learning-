...
## 目錄
### 介紹Julia
1.1 [下載 Julia](#1-下載-julia)

1.2 [安裝說明（Windows / macOS ）](#2-安裝說明)

1.3 [在 Jupyter 中使用 Julia（安裝 IJulia、啟動 Notebook: Jupyter）](#3使用jupyter編譯器)

1.4 [認識 Julia 管理套件 ](#4-julia-套件管理package-management)
